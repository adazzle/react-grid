...
var CopyableCellMixin    = require('../mixins/CopyableMixin');
var DraggableCellMixin   = require('../mixins/DraggableMixin');
...
var ExcelCell = React.createClass({
  ...
  mixins : MixinHelper.mix([KeyboardHandlerMixin, SelectableMixin, EditableMixin, CopyableMixin, DraggableMixin]),
