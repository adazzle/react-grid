...
var CellControls = React.createClass({
  ...
  render : function(){
    return (<div className="pull-right btn-group">
              <button type="button" className="btn btn-link btn-xs">Show More</button><button onClick={this.onClickEdit} type="button" className="btn btn-link btn-xs">Edit</button>
            </div>)
  }
