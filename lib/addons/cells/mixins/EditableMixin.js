...
var EditableMixin = MixinHelper.createDependency({
  ...
  SelectableMixin : SelectableMixin
    ...
    getEditor(){
      ...
      var editorProps = {height : this.props.height, onCommit : this.onCommit, initialKeyCode : this.props.selected.initialKeyCode, editorRowMetaData : this.getEditorRowMetaData()};
    ...
    getEditorRowMetaData(){
      ...
      if(typeof this.props.column.getEditorRowMetaData === 'function'){
        return this.props.column.getEditorRowMetaData(this.props.row);
      }
    },
