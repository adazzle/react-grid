...
var Cell = React.createClass({
  ...
  componentWillMount: function() {
    //moved from getDefaultProps as that is cached across all instances
    //this also allows mixins (like GridSelectionMixin) to override the renderer in their componentWillMount
    this.props.renderer = this.props.column.renderer || simpleCellRenderer;
  }
});
