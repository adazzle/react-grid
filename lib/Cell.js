...
var Cell = React.createClass({
  ...
  renderCellContent(props) {
    if (React.isValidComponent(this.props.formatter)) {
      return <div className="react-grid-Cell__value">{cloneWithProps(this.props.formatter, props)}</div>;
    } else {
      return <div className="react-grid-Cell__value">{this.props.formatter(props)}</div>;
    }
  },
