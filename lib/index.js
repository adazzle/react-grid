...
var EditableCell = React.createClass({
    	...
    	if(this.props.value.editing) {
	    	return (
		      <div onClick={this.handleClick}>
		      	<input type="text" value={this.props.value.value}/>        
		      </div>)
	    }
	    return (
	      <div onClick={this.handleClick}>
	...
	handleClick: function(ev) {		
		console.log('editable cell click');
	}
});
...
var handleGridClick = function(ev) {

	console.log('grid click');
}

var handleGridDoubleClick = function(ev) {

	console.log('grid double click');
}
