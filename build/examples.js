...
/***/ function(module, exports, __webpack_require__) {
	...
	var basicExample = __webpack_require__(8);
	var editableExample = __webpack_require__(9);
	...
	var App = React.createClass({displayName: 'App',
	  ...
	  render: function () {
	    return (
	      ...
	      React.createElement("h1", {className: "page-header"}, "React Grid Examples"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var EditableMixin        = __webpack_require__(30);
		var CopyableMixin        = __webpack_require__(31);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React               = __webpack_require__(9);
		var PropTypes           = React.PropTypes;
		var SortableHeaderCell  = __webpack_require__(35);
		var shallowCloneObject  = __webpack_require__(36);
	...
	/***/ function(module, exports, __webpack_require__) {
		...
		var React               = __webpack_require__(9);
		var PropTypes           = React.PropTypes;
		var FilterableHeaderCell = __webpack_require__(34);
	      ...
	      React.createElement("div", null, 
	        ...
	        React.createElement("div", {className: "code-block js"}, 
	          React.createElement("pre", null, 
	            React.createElement("code", {className: "javascript"}, "var getRows = function(start, end) {\n var result = []; \n   for (var i = start; i < end; i++) {\n     result.push({id: i,title: 'Title ' + i, count: i * 1000 }); \n    } \n  return result; \n}"
	            )
	          )
	        )
	      ))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RowsDescription = __webpack_require__(2)
	var HightlightMixin = __webpack_require__(4);
	...
	module.exports = React.createClass({displayName: 'exports',
	  ...
	  render : function(){
	    return(
	      ...
	      React.createElement("p", null, "In order to display a simple uneditable grid, all that is required is to pass an array of columns and rows as props to ReactGrid. The columns is a column specification, it provides information to grid on how to extract data for each of the column and how column should be represented and its features:"), 
	      React.createElement("div", {className: "code-block js"}, 
	      React.createElement("pre", null, 
	      React.createElement("code", {className: "javascript"}, "var columns = [{ key: 'id', name: 'ID' }, { key: 'title', name: 'Title' }, { key: 'count', name: 'Count' } ]"
	      )
	      )
	      ), 
	      ...
	      React.createElement("div", {className: "code-block js"}, 
	      React.createElement("pre", null, React.createElement("code", {className: "javascript"}, "React.render(<ReactGrid columns={columns} rows={getRows(0,100)} />, document.getElementById('example'))"))
	      )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactGrid = __webpack_require__(1);
	var getRows   = __webpack_require__(3);
	  ...
	  render:function(){
	    return(
	      React.createElement("div", null, 
	        ...
	        React.createElement(ReactGrid, {rows: getRows(0,100), columns: columns})
	      )
	      )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Description = React.createClass({displayName: 'Description',
	  ...
	  render : function(){
	    return(
	      React.createElement("div", null, 
	        React.createElement("h3", {id: "js-basic-example"}, "Editable Example"), 
	        React.createElement("p", null, "To make the Grid editable, simply add an editable property to whichever columns you want to be editable. In this case the Title and Count columns will become editable."), 
	        React.createElement("div", {className: "code-block js"}, 
	          React.createElement("pre", null, 
	            React.createElement("code", {className: "javascript"}, "var columns = [\n{ key: 'id', name: 'ID' }, \n{ key: 'title', name: 'Title', editable : true }, \n{ key: 'count', name: 'Count', editable : true } \n]"
	            )
	          )
	      ), 

	      React.createElement("p", null, "One goal of ReactGrid is to allow the end user to manage the grid data how they want. ReactGrid just provides callbacks that can be listened to, to change data as needed. Here we will create our own editable grid React component, which will wrap ReactGrid. We need to hook onto ReactGrids onRowUpdatedEvent and update the row where the commit was made. Finally, make sure cell selection is enabled for the grid by passing enableCellSelect as prop"), 
	      React.createElement("div", {className: "code-block js"}, 
	        React.createElement("pre", null, React.createElement("code", {className: "javascript"}, "var EditableGrid = React.createClass({\n\n   getInitialState : function(){\n     return {rows : getRows(0, 1000)};\n   },\n\n    handleRowUpdated : function(commit){\n     //merge the updated row values with the existing row\n     var rows = this.state.rows;\n     var updatedRow = React.addons.update(rows[commit.rowIdx], {$merge : commit.updated});\n     rows[commit.rowIdx] = updatedRow;\n     this.setState({rows:rows});\n   },\n\n  render : function(){\n    return(<ReactGrid \n       rows={getRows(0,100)} \n      columns={columns} \n      enableCellSelect={true} \n      onRowUpdated={this.handleRowUpdated}/> \n   );\n }\n});"))
	      )
	      )
	    );
	  }
	...
	var EditableGrid = React.createClass({displayName: 'EditableGrid',
	  ...
	  render : function(){
	    return(React.createElement(ReactGrid, {rows: this.state.rows, columns: columns, enableCellSelect: true, onRowUpdated: this.handleRowUpdated}));
	  }
	});
	...
	module.exports = React.createClass({displayName: 'exports',
	  ...
	  render:function(){
	    return(
	      ...
	      React.createElement(EditableGrid, null)
	      )
	    )
	  }
